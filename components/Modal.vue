    ...
    <div>
        ...
        <div id="default-modal"
            ...
            <div class="relative p-4 w-full max-h-full max-w-4xl">
                <!-- Modal content -->
                <div class="relative bg-white rounded-lg shadow bg-gray-700/75">
                    <!-- Modal header -->
                    ...
                    <div class="p-4 md:p-5 space-y-4">
                        ...
                        <ul class="text-base leading-relaxed text-gray-500 text-gray-400">
